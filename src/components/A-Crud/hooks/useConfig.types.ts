import type { ElDrawerType, ElFormType, ElPaginationType, ElTableType, HooksConfig, MakeOtherPropertiesOptional, Source } from './index.types'

export type CrudProps<T> = MakeOtherPropertiesOptional<CrudConfig<T>, 'url' | 'source'>
